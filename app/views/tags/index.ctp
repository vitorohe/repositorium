...
<div class="input select">
	...
	<div class="checkbox"><input type="checkbox" name="data[Criteria][id][]" value="<?php echo $c['id']; ?>" id="CriteriaId<?php echo $c['id']; ?>"><label class="search-criteria-option" for="CriteriaId<?php echo $c['id']; ?>"><?php echo $c['name']; ?></label></div>
	<?php endforeach; ?>
</div>
<?php else: ?>

...
<table id="tabla_documentos" class="ui-widget ui-widget-content tabla" style="width: 100%">
  <thead>
	<tr class="ui-widget-header">
	  ...
	  <?php if($creator):?>
	  <th width="170" title=""><?php echo 'Unset Expert'; ?></th>
	  <?php endif;?>
	</tr>
  </thead>
  <tbody>
  	...
  	?>
  		...
  		<tr>
  			<td><?php echo Sanitize::html($ast.$user['User']['name']); ?></td>
  			<td><?php echo Sanitize::html($user['User']['email']); ?></td>
  			<?php if($creator):?>
  			<td>
				<?php echo $this->Html->link('Unset Expert', array('action' => 'setUserExpert', $criteria['Criteria']['id'], $user['User']['id'], 2)); ?>
  			</td>
  			<?php endif;?>
  		</tr>
  	<?php
...
<?php echo '<span><small>*This user created the criteria</small></span>'; ?>
<?php echo $this->element('paginator'); ?>
<?php } else {?>
<strong>There aren't experts users in this Criteria</strong>
<?php }?>
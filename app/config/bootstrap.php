...
// subdomains repositories feature
...
if(Configure::read('App.subdomains')) {
	...
	// urls of the form repo_name.example.com, passing 'repo_name' to Configure instance
	...
	// and set the sub-domain name to our registry so we can use it later
		...
		Configure::write('Route.default', array('controller' => 'repositories', 'action' => 'index', $url[0]));
